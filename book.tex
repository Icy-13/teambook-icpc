...
\includecpp{Эйлеров цикл}{./algos/euler_cycle.cpp}
\includecpp{Кун}{./algos/kuhn.cpp}
...
\includecpp{Лямбда}{./algos/lambda.cpp}

\section{Матеша}

\includecpp{Алгебра}{./algos/algebra.cpp}
\includecpp{Количество разбиений}{./algos/number_partition.cpp}
\includecpp{Реккурента по последовательности}{./algos/berlekamp_massey.cpp}
\includecpp{k-ый член последовательности заданной линейной реккурентой}{./algos/linear_reccurence.cpp}
\includecpp{Длинка и интмод}{./algos/long_ar.cpp}
\includecpp{Геома (old)}{./algos/geometry.cpp}
\includecpp{Геома (new)}{./algos/tizz1e_geometry.cpp}
\end{multicols}

\section{Разное}
\includecpp{Тернарник с золотым сечением}{./algos/golden_ternary.cpp}
